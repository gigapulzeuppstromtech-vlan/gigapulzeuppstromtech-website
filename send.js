...
module.exports = async (req, res) => {
  ...
  // Output/log the Portal Initialization inputs directly to Vercel Logs
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: gmailUser,
      pass: gmailPass, // 16-character App Password generated from Google
    },
  });
  ...
  try {
    ...
    // Output the input fields in the successful JSON response
